...
out_path_CNN = cfg['inputs_path']+cfg['product']+'/'+str(cfg['spatial_resolution'])+'/' + cfg['workname'] + '/' + 'GRU' +'/focast_time '+ str(cfg['forcast_time']) +'/'
out_path_convlstm = cfg['inputs_path']+cfg['product']+'/'+str(cfg['spatial_resolution'])+'/' + cfg['workname'] + '/' + 'BILSTM' +'/focast_time '+ str(cfg['forcast_time']) +'/'
...
r2_convlstm  = np.load(out_path_convlstm+'r2_'+'BILSTM'+'.npy')
r_convlstm  = np.load(out_path_convlstm+'r_'+'BILSTM'+'.npy')
urmse_convlstm  = np.load(out_path_convlstm+'urmse_'+'BILSTM'+'.npy')
...
r2_cnn  = np.load(out_path_CNN+'r2_'+'GRU'+'.npy')
r_cnn  = np.load(out_path_CNN+'r_'+'GRU'+'.npy')
urmse_cnn  = np.load(out_path_CNN+'urmse_'+'GRU'+'.npy')
...
lon_ = np.load(PATH+'lon_1.npy')
lat_ = np.load(PATH+'lat_1.npy')
...
print('the average r2 of BILSTM model is :',np.nanmean(r2_convlstm[mask==1]))
print('the average r2 of LSTM model is :',np.nanmean(r2_lstm[mask==1]))
print('the average r2 of GRU model is :',np.nanmean(r2_cnn[mask==1]))

print('the average ubrmse of BILSTM model is :',np.nanmean(urmse_convlstm[mask==1]))
print('the average ubrmse of LSTM model is :',np.nanmean(urmse_lstm[mask==1]))
print('the average ubrmse of GRU model is :',np.nanmean(urmse_cnn[mask==1]))

print('the average r of BILSTM model is :',np.nanmean(r_convlstm[mask==1]))
print('the average r of LSTM model is :',np.nanmean(r_lstm[mask==1]))
print('the average r of GRU model is :',np.nanmean(r_cnn[mask==1]))
